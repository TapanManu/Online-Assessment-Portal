      ...
      <MDBContainer className="mt-5">
        ...
        <MDBRow className="p-sm-2 mt-sm-4">
          <MDBCol size="8">
            ...
            <MDBView waves>
              <img
                src="https://d10lpgp6xz60nq.cloudfront.net/q-thumbnail/3912984.png"
                className="img-fluid"
          ...
          <MDBCol size="4">
            <div>
              <center>
                <div
                  class="custom-control custom-checkbox p-sm-3"
                ...
                >
                  <input
                    ...
                    id="op1"
                  ></input>
                  <label class="custom-control-label" for="op1">
                    Option1
                  </label>
                </div>
                <div class="custom-control custom-checkbox p-sm-3">
                  <input
                    ...
                    id="op2"
                  ></input>
                  <label class="custom-control-label" for="op2">
                    Option2
                  </label>
                </div>
                <div class="custom-control custom-checkbox p-sm-3">
                  <input
                    ...
                    id="op3"
                  ></input>
                  <label class="custom-control-label" for="op3">
                    Option3
                  </label>
                </div>
                <div class="custom-control custom-checkbox p-sm-3">
                  <input
                    ...
                    id="op4"
                  ></input>
                  <label class="custom-control-label" for="op4">
                    Option4
                  </label>
                </div>
                <MDBBtn
          ...
          <div className="pl-sm-5 " aria-label="Question Number">
            <MDBBtnGroup className="mr-auto">
              <MDBBtn outline className="mr-sm-5 mb-sm-4 font-weight-bold">
                1
              </MDBBtn>
              <MDBBtn outline className="mr-sm-5 mb-sm-4 font-weight-bold">
                2
